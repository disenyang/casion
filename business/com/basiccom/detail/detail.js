...
export default{
    ...
    methods: {
        ...
        viewcodeChange(){
            ...
            this.$http.post("/casion/basiccom/saveViewcode", {
                id:this.$route.params.id,
        ...
        jscodeChange(){
            ...
            this.$http.post("/casion/basiccom/saveJscode", {
                id:this.$route.params.id,
                jscode:this.jscode
            }).then((response) => {
        ...
        stylecodeChange(){
            ...
            this.$http.post("/casion/basiccom/saveStylecode", {
                id:this.$route.params.id,
        ...
        testcodeChange(){
            ...
            this.$http.post("/casion/basiccom/saveTestcode", {
                id:this.$route.params.id,
